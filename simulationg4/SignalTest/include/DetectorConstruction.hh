...
public:
  ...
  inline void SetSensorDir(std::string sensorDir)   {m_initParams->SetSensorDir(sensorDir);}
  ...
  inline G4double GetNPercentage() {return perN;};
  inline G4double GetIsoPercentage() {return perIso;};
  inline G4double GetGasPressure() {return gasPressure;};

  void SetNPercentage(G4double z);
  void SetIsoPercentage(G4double z);
  void SetGasPressure(G4double z);
...
private:
  ...
  G4double fdriftDist, fpolyThickness1, fpolyThickness2, fCdThickness, fB4C_z, perN, perIso, perAr, gasPressure,fAl_2_Thickness;
