...
public:
  ...
  inline void SetIdealField(bool state)         {m_idealField =  state;}
  inline void SetUseGarfield(bool state)        {m_useGarfield = state;}
  inline void SetSrimFile(std::string file)     {m_srimFile = file;}
  
  inline void SetDetectorRadius(double detectorRadius){m_detectorRadius=detectorRadius;}
  inline void SetAnodeRadius(double anodeRadius){m_anodeRadius=anodeRadius;}
  inline void SetAnodeVoltage(double anodeVoltage){m_anodeVoltage=anodeVoltage;}
  ...
  inline bool    GetIdealField()    {return m_idealField;}
  inline bool    GetUseGarfield()   {return m_useGarfield;}
  inline std::string GetSrimFile()  {return m_srimFile;}
  
  inline double GetDetectorRadius() {return m_detectorRadius;}
  inline double GetAnodeRadius() {return m_anodeRadius;}
  inline double GetAnodeVoltage() {return m_anodeVoltage;}
private:
  ...
  double m_anodeRadius;
  bool m_idealField;
  bool m_useGarfield;
  std::string m_srimFile;
  
  bool    m_safetyCounter;
  double  m_pressure;
  double m_anodeVoltage;
};
