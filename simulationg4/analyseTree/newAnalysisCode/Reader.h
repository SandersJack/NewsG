...
// Wed Aug 21 11:42:54 2019 by ROOT version 6.16/00
// from TTree simul/energy
// found on file: output_gamma_5.9+keV_spherical+29+1+0+cm_radial_5000_20190812.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_gamma_5.9+keV_spherical+29+1+0+cm_radial_5000_20190812.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_gamma_5.9+keV_spherical+29+1+0+cm_radial_5000_20190812.root");
      }
...
void Reader::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("PrimaryVolume", &PrimaryVolume, &b_PrimaryVolume);
