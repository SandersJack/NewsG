...
int main()
{
  TString fileName = "/disk/moose/general/user149/output_gamma_5.9+keV_spherical+29+-0.98+0+cm_radial_5000_20190805.root";
  ...
  TH2F* h_nInitElecPos = new TH2F("h_nInitElecPos",";x;y",100,0,100,300,-300,0);
  TH2F* h_nInitElecPos1 = new TH2F("h_nInitElecPos1",";x;y",100,0,100,300,-300,0);
  TH2F* h_nInitElecPos2 = new TH2F("h_nInitElecPos2",";x;y",100,0,100,300,-300,0);
  TH2F* h_nInitElecPos3 = new TH2F("h_nInitElecPos3",";x;y",100,0,100,300,-300,0);
  TH2F* h_nInitElecPos4 = new TH2F("h_nInitElecPos4",";x;y",100,0,100,300,-300,0);
  TH2F* h_nInitElecPos5 = new TH2F("h_nInitElecPos5",";x;y",100,0,100,300,-300,0);
  ...
  TH2F* h_nAmpRiseTime = new TH2F("h_nAmpRiseTime",";Amplitude;Rise Time;",1100,0,5500,200,0,300);
  ...
  int R1Events,R1Elec,R2Events,R2Elec,R3Events,R3Elec,R4Events,R4Elec,R5Events,R5Elec,RAllEvents,RAllElec;
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++)
      ...
      if (Amplitude<200)
	{
      ...
      //Region 3
	 else if (Amplitude>2600 && RiseTime<40)
	{
	  R3Events += 1;
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
      ...
      //Region 2
      else if (RiseTime>-0.1*Amplitude+300)
	{
	  R2Events += 1;
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
  ...
  TCanvas*c22=new TCanvas("c22","Initial Electron Position 1",200,600);
  ...
  TCanvas*c23=new TCanvas("c23","Initial Electron Position 2",200,600);
  ...
  TCanvas*c24=new TCanvas("c24","Initial Electron Position 3",200,600);
  ...
  TCanvas*c25=new TCanvas("c25","Initial Electron Position 4",200,600);
