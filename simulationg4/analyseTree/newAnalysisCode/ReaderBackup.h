...
// Tue Jul 30 10:10:18 2019 by ROOT version 6.16/00
// from TTree simul/energy
// found on file: outputFromBottom.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/disk/moose/general/user149/output_gamma_5.9+keV_speherical+29+0+0+cm_sperical+-1+0+0_5000_20190729.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/disk/moose/general/user149/output_gamma_5.9+keV_speherical+29+0+0+cm_sperical+-1+0+0_5000_20190729.root");
      }
