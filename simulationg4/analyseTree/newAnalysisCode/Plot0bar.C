...
int main()
{
  TString fileName = "/disk/moose/general/user149/output_gamma_5.9+keV_spherical+29+0+0+cm_radial_5000_20190805.root";
  ...
  TH2F* h_nInitElecPos = new TH2F("h_nInitElecPos",";x;y",300,0,300,200,-10,10);
  TH2F* h_nInitElecPos1 = new TH2F("h_nInitElecPos1",";x;y",300,0,300,200,-10,10);
  TH2F* h_nInitElecPos2 = new TH2F("h_nInitElecPos2",";x;y",300,0,300,200,-10,10);
  TH2F* h_nInitElecPos3 = new TH2F("h_nInitElecPos3",";x;y",300,0,300,200,-10,10);
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++)
      ...
      if (Amplitude>2600 && RiseTime<30)
	{
      ...
      //Region 2
      else if (Amplitude>2500 && RiseTime>30)
	{
	  R2Events += 1;
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
