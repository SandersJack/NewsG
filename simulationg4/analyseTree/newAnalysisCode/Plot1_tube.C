...
int main()
{
  TString fileName = "/disk/moose/general/user149/output_gamma_5.9+keV_spherical+29+1+0+cm_radial_5000_20190805.root";
  ...
  TH1F* h_nElec6 = new TH1F("h_nElec6",";Number of Electrons;",250,0,500);
  TH1F* h_nElec7 = new TH1F("h_nElec7",";Number of Electrons;",250,0,500);
  TH1F* h_nElec8 = new TH1F("h_nElec8",";Number of Electrons;",250,0,500);
  ...
  TH2F* h_nInitElecPos = new TH2F("h_nInitElecPos",";x;y",100,0,10,300,0,300);
  TH2F* h_nInitElecPos1 = new TH2F("h_nInitElecPos1",";x;y",100,0,10,300,0,300);
  TH2F* h_nInitElecPos2 = new TH2F("h_nInitElecPos2",";x;y",100,0,10,300,0,300);
  TH2F* h_nInitElecPos3 = new TH2F("h_nInitElecPos3",";x;y",100,0,10,300,0,300);
  TH2F* h_nInitElecPos4 = new TH2F("h_nInitElecPos4",";x;y",100,0,10,300,0,300);
  TH2F* h_nInitElecPos5 = new TH2F("h_nInitElecPos5",";x;y",100,0,10,300,0,300);
  TH2F* h_nInitElecPos6 = new TH2F("h_nInitElecPos6",";x;y",100,0,10,300,0,300);
  TH2F* h_nInitElecPos7 = new TH2F("h_nInitElecPos7",";x;y",100,0,10,300,0,300);
  TH2F* h_nInitElecPos8 = new TH2F("h_nInitElecPos8",";x;y",100,0,10,300,0,300);
  ...
  TH1F* h_nPulseWidth6 = new TH1F("h_nPulseWidth6",";Pulse Width;",200,0,1000);
  TH1F* h_nPulseWidth7 = new TH1F("h_nPulseWidth7",";Pulse Width;",200,0,1000);
  TH1F* h_nPulseWidth8 = new TH1F("h_nPulseWidth8",";Pulse Width;",200,0,1000);
  ...
  TH1F* h_nPulseIntegral6 = new TH1F("h_nPulseIntegral6",";Integral:",200,0,2e6);
  TH1F* h_nPulseIntegral7 = new TH1F("h_nPulseIntegral7",";Integral:",200,0,2e6);
  TH1F* h_nPulseIntegral8 = new TH1F("h_nPulseIntegral8",";Integral:",200,0,2e6);
  ...
  int R1Events,R1Elec,R2Events,R2Elec,R3Events,R3Elec,R4Events,R4Elec,R5Events,R5Elec,R6Events,R6Elec,R7Events,R7Elec,R8Events,R8Elec,RAllEvents,RAllElec;
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++)
      ...
      if (Amplitude<600)
	{
	  ...
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
	      R8Elec += 1;
	      h_nInitElecPos8->Fill(Radius[elecNumber]*SinTheta[elecNumber],Radius[elecNumber]*CosTheta[elecNumber]);
	    }
	  
	  h_nElec8->Fill(myReader.InitElecRadius->size());
	  h_nPulseWidth8->Fill(nPulset[Index50_high]-nPulset[Index50_low]);
	  h_nPulseIntegral8->Fill(PulseIntegral);
	}

      //Region 7
      if (RiseTime<10   && 3000<Amplitude)
	{
	  R7Events += 1;
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
	      R7Elec += 1;
	      h_nInitElecPos7->Fill(Radius[elecNumber]*SinTheta[elecNumber],Radius[elecNumber]*CosTheta[elecNumber]);
	    }
	  
	  h_nElec7->Fill(myReader.InitElecRadius->size());
	  h_nPulseWidth7->Fill(nPulset[Index50_high]-nPulset[Index50_low]);
	  h_nPulseIntegral7->Fill(PulseIntegral);
	}
      ...
      if (RiseTime>110)
	{
	  ...
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
	      R6Elec += 1;
	      h_nInitElecPos6->Fill(Radius[elecNumber]*SinTheta[elecNumber],Radius[elecNumber]*CosTheta[elecNumber]);
	    }
	  
	  h_nElec6->Fill(myReader.InitElecRadius->size());
	  h_nPulseWidth6->Fill(nPulset[Index50_high]-nPulset[Index50_low]);
	  h_nPulseIntegral6->Fill(PulseIntegral);
	}
      
      //Region 4
      if (Amplitude>2800 && 25<RiseTime && RiseTime<35)
	{
	  R4Events += 1;
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
      ...
      //Region 3
      else if (Amplitude>2800 && RiseTime<25)
	{
	  R3Events += 1;
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
	  ...
	  h_nPulseIntegral3->Fill(PulseIntegral);
         ...
         //Region 5
	 else if (Amplitude>2300 && RiseTime>35)
	 {
	 R5Events += 1;
	 for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	 {
      ...
      for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	{
      ...
      /*TFile*fileOutPulseCut=new TFile("./Output_from_" + cos + "_" + energy + "_analysis/Pulse_and_signal.root","Update");
 ...
 TCanvas*c1=new TCanvas("c1","Number of electrons per event",600,600);
  ...
  h_nElec2->SetFillColor(kRed-7);
  h_nElec3->SetFillColor(kBlue+3);
  h_nElec4->SetFillColor(kBlue-2);
  h_nElec5->SetFillColor(kBlue-6);
  h_nElec6->SetFillColor(kCyan+2);
  h_nElec7->SetFillColor(kGreen+2);
  h_nElec8->SetFillColor(kMagenta+2);
  ...
  h_nElec->Add(h_nElec6);
  h_nElec->Add(h_nElec7);
  h_nElec->Add(h_nElec8);
  h_nElec->Draw();
  auto legendElec = new TLegend(0.6,0.7,0.9,0.9);
  legendElec->AddEntry(h_nElec1,"Region 1.1","f");
  legendElec->AddEntry(h_nElec2,"Region 1.2","f");
  legendElec->AddEntry(h_nElec3,"Region 2.1","f");
  legendElec->AddEntry(h_nElec4,"Region 2.2","f");
  legendElec->AddEntry(h_nElec5,"Region 2.3","f");
  legendElec->AddEntry(h_nElec6,"Region 3","f");
  legendElec->AddEntry(h_nElec7,"Region 4","f");
  legendElec->AddEntry(h_nElec8,"Region 5","f");
  legendElec->Draw();
  ...
  h_nPulseWidth2->SetFillColor(kRed-7);
  h_nPulseWidth3->SetFillColor(kBlue+3);
  h_nPulseWidth4->SetFillColor(kBlue-2);
  h_nPulseWidth5->SetFillColor(kBlue-6);
  h_nPulseWidth6->SetFillColor(kCyan+2);
  h_nPulseWidth7->SetFillColor(kGreen+2);
  h_nPulseWidth8->SetFillColor(kMagenta+2);
  ...
  h_nPulseWidth->Add(h_nPulseWidth6);
  h_nPulseWidth->Add(h_nPulseWidth7);
  h_nPulseWidth->Add(h_nPulseWidth8);
  h_nPulseWidth->Draw();
  ...
  legendPulseWidth->AddEntry(h_nPulseWidth5,"Region 5","f");
  legendPulseWidth->AddEntry(h_nPulseWidth5,"Region 5","f");
  legendPulseWidth->AddEntry(h_nPulseWidth6,"Region 6","f");
  legendPulseWidth->AddEntry(h_nPulseWidth7,"Region 7","f");
  legendPulseWidth->AddEntry(h_nPulseWidth8,"Region 8","f");
  ...
  h_nPulseIntegral2->SetFillColor(kRed-7);
  h_nPulseIntegral3->SetFillColor(kBlue+3);
  h_nPulseIntegral4->SetFillColor(kBlue-2);
  h_nPulseIntegral5->SetFillColor(kBlue-6);
  h_nPulseIntegral6->SetFillColor(kCyan+2);
  h_nPulseIntegral7->SetFillColor(kGreen+2);
  h_nPulseIntegral8->SetFillColor(kMagenta+2);
  ...
  h_nPulseIntegral->Add(h_nPulseIntegral6);
  h_nPulseIntegral->Add(h_nPulseIntegral7);
  h_nPulseIntegral->Add(h_nPulseIntegral8);
  ...
  legendPulseIntegral->AddEntry(h_nPulseIntegral6,"Region 6","f");
  legendPulseIntegral->AddEntry(h_nPulseIntegral7,"Region 7","f");
  legendPulseIntegral->AddEntry(h_nPulseIntegral8,"Region 8","f");
  legendPulseIntegral->Draw();
  c20->SaveAs(fileOutHistpdf + "PulseIntegral.pdf");

  gStyle->SetPalette(51);
  TCanvas*c21=new TCanvas("c21","Initial Electron Position",200,600);
  ...
  TCanvas*c22=new TCanvas("c22","Initial Electron Position 1.1",200,600);
  ...
  TCanvas*c23=new TCanvas("c23","Initial Electron Position 1.2",200,600);
  ...
  TCanvas*c24=new TCanvas("c24","Initial Electron Position 2.1",200,600);
  ...
  TCanvas*c25=new TCanvas("c25","Initial Electron Position 2.2",600,600);
  ...
  TCanvas*c26=new TCanvas("c26","Initial Electron Position 2.3",200,600);
  ...
  TCanvas*c27=new TCanvas("c27","Initial Electron Position 3",200,600);
  h_nInitElecPos6->SetOption("colz");
  h_nInitElecPos6->SetStats(kFALSE);
  h_nInitElecPos6->GetXaxis()->SetLabelSize(0.05);
  h_nInitElecPos6->GetYaxis()->SetLabelSize(0.05);
  h_nInitElecPos6->Draw();
  c26->SaveAs(fileOutHistpdf + "InitElecPos6.pdf");
  TCanvas*c28=new TCanvas("c28","Initial Electron Position 4",200,600);
  h_nInitElecPos7->SetOption("colz");
  h_nInitElecPos7->SetStats(kFALSE);
  h_nInitElecPos7->GetXaxis()->SetLabelSize(0.05);
  h_nInitElecPos7->GetYaxis()->SetLabelSize(0.05);
  h_nInitElecPos7->Draw();
  c26->SaveAs(fileOutHistpdf + "InitElecPos7.pdf");
  TCanvas*c29=new TCanvas("c29","Initial Electron Position 5",200,600);
  h_nInitElecPos8->SetOption("colz");
  h_nInitElecPos8->SetStats(kFALSE);
  h_nInitElecPos8->GetXaxis()->SetLabelSize(0.05);
  h_nInitElecPos8->GetYaxis()->SetLabelSize(0.05);
  h_nInitElecPos8->Draw();
  c26->SaveAs(fileOutHistpdf + "InitElecPos8.pdf");
  

  RAllEvents = R1Events + R2Events + R3Events + R4Events + R5Events + R6Events + R7Events + R8Events;
  RAllElec = R1Elec + R2Elec + R3Elec + R4Elec + R5Elec + R6Elec + R7Elec + R8Elec;
  ...
  std::cout << "In region 4 there are " << R4Elec << ", " << R4Elec*100/RAllElec << "% electrons and " << R4Events << ", " << R4Events*100/RAllElec << "% events. \n";
  std::cout << "In region 5 there are " << R5Elec << ", " << R5Elec*100/RAllElec << "% electrons and " << R5Events << ", " << R5Events*100/RAllElec << "% events. \n";
  std::cout << "In region 6 there are " << R6Elec << ", " << R6Elec*100/RAllElec << "% electrons and " << R6Events << ", " << R6Events*100/RAllElec << "% events. \n";
  std::cout << "In region 7 there are " << R7Elec << ", " << R7Elec*100/RAllElec << "% electrons and " << R7Events << ", " << R7Events*100/RAllElec << "% events. \n";
  std::cout << "In region 8 there are " << R8Elec << ", " << R8Elec*100/RAllElec << "% electrons and " << R8Events << ", " << R8Events*100/RAllElec << "% events. \n";
  ...
  h_nInitElecPos6->Write();
  h_nInitElecPos7->Write();
  h_nInitElecPos8->Write();
  fileOutHist->Close();
