...
class MediumGas : public Medium {
 public:
  ...
  /// Set the gas mixture.
  bool SetComposition(const std::array<std::string, 6> gases, const std::array<double, 6> fractions);
  bool SetComposition(const std::vector<std::string> gas, const std::vector<double> f);
