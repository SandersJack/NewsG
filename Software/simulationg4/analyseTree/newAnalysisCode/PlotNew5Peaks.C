...
int main()
{
  ...
  //TH1F* h_nElec4 = new TH1F("h_nElec4",";Number of Electrons;",500,0,500);
  //TH1F* h_nElec5 = new TH1F("h_nElec5",";Number of Electrons;",500,0,500);
  ...
  //TH1F* h_nPulseWidth4 = new TH1F("h_nPulseWidth4",";Pulse Width;",100,0,1000);
  //TH1F* h_nPulseWidth5 = new TH1F("h_nPulseWidth5",";Pulse Width;",100,0,1000);
  ...
  //TH1F* h_nPulseIntegral4 = new TH1F("h_nPulseIntegral4",";Integral:",100,0,2e6);
  //TH1F* h_nPulseIntegral5 = new TH1F("h_nPulseIntegral5",";Integral:",100,0,2e6);

  std::vector <double> CosTheta;
  std::vector <double> Radius;
  std::vector <double> SinTheta;

  int R1Events,R1Elec,R2Events,R2Elec,R3Events,R3Elec,RAllEvents,RAllElec;
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++)
      ...
      if (Amplitude>2600 && RiseTime<30)
	{
      ...
      //Region 2
      else if (Amplitude>2400 && RiseTime>30)
	{
	  R2Events += 1;
	  for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	    {
      ...
      /* //Region 4
	 else if (RiseTime<160 && RiseTime>115)
	 {
	 R4Events += 1;
	 for (int elecNumber = 0; elecNumber<Radius.size(); elecNumber++)
	 {
  ...
  TString fileOutHistpdf("./Output_from_" + cos + "_" + energy + "_analysis/Histograms3/");
...
/* TCanvas*c1=new TCanvas("c1","Number of electrons per event",600,600);
  ...
  // h_nElec4->SetFillColor(kCyan);
  //h_nElec5->SetFillColor(kMagenta);
  ...
  //h_nPulseWidth4->SetFillColor(kCyan);
  //h_nPulseWidth5->SetFillColor(kMagenta);
  ...
  //h_nPulseIntegral4->SetFillColor(kCyan);
  //h_nPulseIntegral5->SetFillColor(kMagenta);
  ...
  TCanvas*c21=new TCanvas("c21","Initial Electron Position",600,200);
  ...
  TCanvas*c22=new TCanvas("c22","Initial Electron Position 1",600,200);
  ...
  TCanvas*c23=new TCanvas("c23","Initial Electron Position 2",600,200);
  ...
  TCanvas*c24=new TCanvas("c24","Initial Electron Position 3",600,200);
  ...
  /*RAllEvents = R1Events + R2Events + R3Events;
  RAllElec = R1Elec + R2Elec + R3Elec;
  ...
  TFile*fileOutHist=new TFile("./Output_from_" + cos + "_" + energy + "_analysis/Histograms3.root","RECREATE");
