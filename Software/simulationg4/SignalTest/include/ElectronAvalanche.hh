...
class ElectronAvalanche
{
 public:
  ...
  inline void SetMCStepType(avalMCStepType theType){m_avalMCStepType=theType;}
  ...
  inline double GetIntegratedTowns()               {return m_intTowns;}
  inline double GetAverageGain()                   {return m_avGain;}
 ...
 private:
  ...
  int AvalancheMicroscopic(double &x0, double &y0, double &z0, double &t0, double &e0, double &dx0, double &dy0, double &dz0);
  int AvalancheMC(double &x0, double &y0, double &z0, double &t0, double &e0, double &dx0, double &dy0, double &dz0);
  int AvalancheCustom(double &x0, double &y0, double &z0, double &t0, double &e0, double &dx0, double &dy0, double &dz0);
