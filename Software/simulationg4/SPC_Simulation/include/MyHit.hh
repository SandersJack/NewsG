...
public:
  ...
  inline void SetStatus(G4double status){m_status = status;}
  ...
  inline void SetElecStatus(G4double status){m_elecStatus = status;}
  ...
  inline void SetGain(double value){m_avgGain = value;}
  ...
  inline G4double      GetStatus(){return m_status;}
