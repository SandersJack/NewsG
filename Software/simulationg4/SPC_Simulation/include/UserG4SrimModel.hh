#ifndef USERG4SRIMMODEL_h
#define USERG4SRIMMODEL_h
...
class UserG4SrimModel: public G4VFastSimulationModel
{
public:
  UserG4SrimModel(const G4String&, G4Region*, InitialisationParameters*, DetectorConstruction* detector);
  ~UserG4SrimModel();
